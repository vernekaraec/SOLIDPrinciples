...
namespace Vernekar.SOLID.DIP
{
    ...
    /// 
    /// Let's conside the Notifiation message to the customer. It can be notified by Email. Later we will see on other type of messaging and how we can improve and use dependence injection
    /// </summary>
    class Program
    {
